...
# from global_variable import socketio
...
#
#
# @socketio.on('message_response', namespace="/wechat")
# def message(message):
#     print(' message_response: ' + message['data'])
#     socketio.emit("response", {'age': 18}, namespace="/wechat")
#
#
# @socketio.on('response', namespace="/wechat")
# def message(message):
