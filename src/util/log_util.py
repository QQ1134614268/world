...
def create_logger(log_dir=LOG_DIR):
    ...
    err_handler = ConcurrentRotatingFileHandler(os.path.join(log_dir, "err.log"), maxBytes=1 * 1024 * 1024,
    ...
    warn_handler = ConcurrentRotatingFileHandler(os.path.join(log_dir, "warn.log"), maxBytes=1 * 1024 * 1024,
                                                 backupCount=10, encoding="utf_8")
    ...
    info_handler = ConcurrentRotatingFileHandler(os.path.join(log_dir, "info.log"), maxBytes=1 * 1024 * 1024,
                                                 backupCount=10, encoding="utf_8")
